        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <?php $dinas_id = $this->uri->segment(3); ?>
              <h3 style="color: #000000"><b>LAPORAN KEGIATAN AKTIFITAS<b></h3>
              ...
              <form class="form-horizontal style-form" action="<?php echo site_url("c_karyawan/saveDinasKegiatan");?>" method="post" enctype="multipart/form-data">
                 <input type="hidden" name="ab_dinas_id" value=<?php echo $ab_dinas_id;?> >
                      ...
                      <div class="col-md-4">
                        <div class="fileupload fileupload-new" data-provides="fileupload">
                          ...
                          <div>
                            ...
                            <a href="<?php echo site_url("c_karyawan/dinasKegiatan/$dinas_id");?>" class="btn btn-theme04 fileupload-exists" data-dismiss="fileupload"><i class="fa fa-trash-o"></i> Remove</a>
                          </div>
                        </div>
