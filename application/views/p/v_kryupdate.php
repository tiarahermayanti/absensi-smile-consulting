<!-- main content start-->
    <section id="main-content">
      <section class="wrapper site-min-height">
       ...
       <form role="form" class="form-horizontal" action="<?php echo site_url('c_pimpinan/updateKaryawan');?>" method="post" enctype="multipart/form-data">
                 ...
                 <div class="col-lg-4 detailed">
                         ...
                         <?php foreach ($user->result() as $u) { ?>
                          ...
                          <div class="centered mt">
                           ...
                           <div class="form-group">
                            <div class="col-lg-12">
                               <span id="generate" style="display: block;margin: auto; " class="btn btn-warning generate">Dapatkan Password Baru</span>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                               <input type="password" id="pass" name="password" value="<?php echo $u->password;?>" class="form-control" readonly>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-6" >
                              <select class="form-control" name="role" required>
                                ...
                                <option value="piminan" <?php if ($u->role == "pimpinan") {echo "selected";} ?>>Pimpinan</option>
                                <option value="karyawan" <?php if ($u->role == "karyawan") {echo "selected";} ?> >Karyawan</option>
                              </select>
                            </div>
                          </div>
                          <?php } ?>
