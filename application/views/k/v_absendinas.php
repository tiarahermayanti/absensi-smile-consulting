      ...
      <section class="wrapperab" >
        <div class="col-lg-12 mt" >
          <div class="row content-panelab centered" >
                  <h1><b>FOTO DIRI ANDA<b></h1>
                   <h4>Lokasi : <?php echo $lokasi;?></h4>
                    <div align="center" style="margin-top: 20px;">
                       <form id="register" action="<?php echo site_url("c_karyawan/saveAbsenDinas/$dinas_id");?>" method="post" enctype="multipart/form-data">
      ...
      // buat elemen img
        ...
        function showPosition(position) {
         ...
         // alert("Yah, "+ lat +", "+ long);
          ...
          $.ajax({
            type: "POST",
            url: "<?php echo site_url("c_karyawan/saveAbsenDinas/$dinas_id");?>",
            data: { 
               getlat: lat,
               getlong : long,
               imgBase64: dataURL
